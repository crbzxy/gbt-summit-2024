...
const Agenda: React.FC = () => {
  ...
  return (
    <div
      className="flex flex-col align-middle justify-center text-center pt-6 pb-12 bg-white shadow-md"
      id="agenda"
    >
      ...
      <table className="w-full text-center border-collapse max-w-5xl m-auto">
        <thead>
          <tr className=" text-white mb-5">
            <th
              className="p-4 rounded-md bg-[#006FCF]"
              style={{ width: "20%" }}
            >
              Horario
            </th>
        ...
        <tbody>
          ...
          {items.map((item) => (
            <tr
              ...
              style={{
                backgroundImage:
                  "radial-gradient(circle, rgba(59,160,228,1), rgba(180,235,255,1))",
            ...
            >
              <td
                ...
                colSpan={2}
                style={{ borderEndStartRadius: 12, borderTopLeftRadius: 12 }}
              >
                {item.horario}
              </td>
              ...
              <td
                ...
                style={{ borderEndEndRadius: 12, borderTopRightRadius: 12 }}
              >
                {item.panelista}
              </td>
            </tr>
