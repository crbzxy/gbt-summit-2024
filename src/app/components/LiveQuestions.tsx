    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                className={`absolute bottom-28 right-12 bg-blue-600 text-white p-4 rounded-full shadow-lg cursor-pointer transition-transform transform hover:scale-105 z-50 flex items-center justify-center space-x-2 ${isCooldown ? 'opacity-50 cursor-not-allowed' : ''} ${isButtonVisible ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}
            >
